...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _listenForNotifications() {
    FirebaseFirestore.instance
      ...
      if (snapshot.docs.isNotEmpty) {
        ...
        // إذا لم أكن أنا المرسل، والإشعار جديد (أقل من 10 ثواني)
  ...
  Widget build(BuildContext context) {
    // قائمة الشاشات (الترتيب مهم جداً)
    // 0: الرئيسية (العداد)
    // 1: الشات
    // 2: الموسيقى
    // 3: الذكريات
    ...
    final List<Widget> screens = [
      _buildHomeTab(), // التبويب الأول (العداد)
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  // الزر العائم في المنتصف (الرئيسية)
                  GestureDetector(
    ...
    return GestureDetector(
      ...
      child: Column(
        ...
        children: [
          Icon(
            icon,
            color: isSelected ? const Color(0xFFE11D48) : Colors.grey[400],
            size: 26,
          ),
          Text(
            label,
  ...
  // محتوى التبويب الأول (عداد الأيام)
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Column(
                        children: [
                          Text("$days", style: const TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold)),
                          const Text("يوماً معاً", style: TextStyle(color: Colors.white70)),
                        ],
                      ),
                      ...
                      const Column(
                        children: [
                          ...
                          Text("إلى الأبد", style: TextStyle(color: Colors.white70)),
                        ],
                      ),
                    ],
                  ),
          ...
          const Text("اضغط لإرسال 'اشتقت لك'", style: TextStyle(color: Colors.grey, fontSize: 16)),
        ],
      ),
    );
  }
